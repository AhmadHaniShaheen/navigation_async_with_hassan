...
class InfoNamedView extends StatefulWidget {
  const InfoNamedView({super.key});

  @override
  State<InfoNamedView> createState() => _InfoViewState();
}

class _InfoViewState extends State<InfoNamedView> {
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              //   );
              // }));
              Navigator.of(context).pushNamed('/show_named_view', arguments: [
                controller.text,
                gender,
                certifecation,
              ]);
